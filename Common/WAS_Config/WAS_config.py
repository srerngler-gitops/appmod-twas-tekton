...
AdminConfigVar_15=AdminTask.createDatasource(AdminConfigVar_11, ["-name", "INDS" , "-jndiName", "jdbc/inds" , "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DB2UniversalDataStoreHelper" , "-componentManagedAuthenticationAlias", Node+'DBUser' , "-xaRecoveryAuthAlias", Node+'DBUser' , "-configureResourceProperties", "[[databaseName java.lang.String INDB] [driverType java.lang.Integer 4] [serverName java.lang.String c-db2-db2u.db2.svc] [portNumber java.lang.Integer 50000] ]" ])
