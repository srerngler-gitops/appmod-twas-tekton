...
AdminConfigVar_1=AdminTask.createDatasource(AdminConfigVar_0, ["-name", "OrderDS", "-jndiName", "jdbc/orderds", "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DB2UniversalDataStoreHelper", "-componentManagedAuthenticationAlias", "Default01Node(cells/Default01Cell/nodes/Default01Node|node.xml#Node_1)DBUser", "-configureResourceProperties", "[[databaseName java.lang.String TORDERDB] [driverType java.lang.Integer 4] [serverName java.lang.String c-db2-db2u.db2.svc] [portNumber java.lang.Integer 50000] ]"])
